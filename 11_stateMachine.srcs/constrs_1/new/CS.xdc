    ...
    set_property PACKAGE_PIN W16 [get_ports {Level[2]}]
        set_property IOSTANDARD LVCMOS33 [get_ports {Level[2]}]
    set_property PACKAGE_PIN V16 [get_ports {Level[1]}]
        set_property IOSTANDARD LVCMOS33 [get_ports {Level[1]}]
    set_property PACKAGE_PIN V17 [get_ports {Level[0]}]
        set_property IOSTANDARD LVCMOS33 [get_ports {Level[0]}]
        
    set_property PACKAGE_PIN V15 [get_ports {Size[2]}]
        set_property IOSTANDARD LVCMOS33 [get_ports {Size[2]}]
    set_property PACKAGE_PIN W15 [get_ports {Size[1]}]
        set_property IOSTANDARD LVCMOS33 [get_ports {Size[1]}]
    set_property PACKAGE_PIN W17 [get_ports {Size[0]}]
